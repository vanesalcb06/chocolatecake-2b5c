[chocolatecake-2b5c] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [chocolatecake-2b5c] container is NOT running**.

.. tip::
   You must have your [chocolatecake-2b5c] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/vanesalcb06/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=36533  \-\-env VIPERVIZPORT=33875  \-\-env GITUSERNAME='vanesalcb06'  \-\-env DOCKERUSERNAME='vanesalcb'  \-\-env MQTTUSERNAME='vanesalcb'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:33875/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:33875/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   vanesalcb/chocolatecake-2b5c-amd64 (https://hub.docker.com/r/vanesalcb/chocolatecake-2b5c-amd64)
...
.. important::
   docker run -d -p 52493:52493 -p 41869:41869 -p 37961:37961 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=chocolatecake-2b5c \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-chocolatecake-2b5c \-\-env GITUSERNAME=vanesalcb06  \-\-env GITREPOURL=https://github.com/vanesalcb06/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=52493  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=41869  \-\-env SOLUTIONVIPERVIZPORT=37961 \-\-env DOCKERUSERNAME='vanesalcb' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=36533 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=33875 \-\-env MQTTUSERNAME='vanesalcb' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  vanesalcb/chocolatecake-2b5c-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - vanesalcb/chocolatecake-2b5c-amd64
...
[chocolatecake-2b5c] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/vanesalcb06/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/chocolatecake-2b5c
...
.. important::
   https://chocolatecake-2b5c.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-chocolatecake-2b5c
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=52493, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45273, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=46543, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=45659, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=43269, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45091, HPDEHOST=127.0.1.1, HPDEPORT=41989, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40623

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6933-chocolatecake-2b5c,solution_preprocessing_ai_mqtt_dag-chocolatecake-2b5c, python-preprocess-8720-chocolatecake-2b5c,solution_preprocessing_ai_mqtt_dag-chocolatecake-2b5c, python-ai-8703-chocolatecake-2b5c,solution_preprocessing_ai_mqtt_dag-chocolatecake-2b5c, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
